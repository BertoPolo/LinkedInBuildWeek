...
const MyProfile = () => {
  ...
  const fetchData = async (param) => {
    try {
      const response = await fetch("https://striveschool-api.herokuapp.com/api/profile/" + param, {
        headers: {
          Authorization:
              ...
              <div id="profileInfosContainer">
                <div className="d-flex justify-content-between align-items-end">
                  <div>
                    ...
                    {id === "me" && (
                      <>
                        <i className="bi bi-camera cameraProfileIcon" onClick={handleShowPicture}></i>
                        {showMyPictureModal ? (
                  ...
                  {id === "me" && (
                    <div className="mr-3 modifyIcon">
                      ...
                      {show ? <MyModal show={show} handleClose={handleClose} fetchData={fetchData} myProfile={myProfile} /> : <></>}
                    </div>
                  )}
                </div>
                <div>
