...
const CreatePost = () => {
  ...
  return (
    <>
        ...
        <Row className="rowFeedBox">
          ...
          <div className="row containerSvg">
            <button className="buttonSrc">
              ...
              <span style={{ margin: "9px", color: "rgb(109, 108, 108)" }}>
                Photo
              </span>
            </button>
            <button className="buttonSrc">
              ...
              <span style={{ margin: "5px", color: "rgb(109, 108, 108)" }}>
                Video
              </span>
            </button>
            <button className="buttonSrc">
      ...
      {openClose && (
        <Container id="box" className="mainBox">
          <div className="row">
            <div>
              <h3 className="createPost">Create a post</h3>
            </div>
            <hr id="break" />

            <div id="mainContainer" className="row">
              <div className="firstContainer col-2">
                <img id="profilePic2" src="" alt="" />
              </div>
              <div className="firstContainer col-10">
                <span id="nameFont">NAME</span>
                <button className="buttonPrivacy">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
            ...
            <div className="commentSection">
              ...
              <button className="addHas">Add Hashtag</button>
            </div>
            <div className="bottomContainer">
              ...
              <div class="vl"></div>
              <button className="buttonPrivacy2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <div>
                <button onClick={PostingFunction} className="lastButton">
                  Post
                </button>
              </div>
            </div>
