...
const PeoplePage = () => {
  ...
  async function getUsers() {
    const response = await fetch("https://striveschool-api.herokuapp.com/api/profile/" + params.id, {
      headers: {
  ...
  const getExperiences = async () => {
    try {
      const response = await fetch(`https://striveschool-api.herokuapp.com/api/profile/:${params.id}/experiences`, {
        headers: {
          "Content-Type": "Application/json",
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MjQxNmU3ZWQzMzk4NDAwMTVjODgzYjYiLCJpYXQiOjE2NDg0NTUyOTgsImV4cCI6MTY0OTY2NDg5OH0.VLQs1aPcryvd-GdlD9l8Fl80QZPNQHjrbWcVQpEBvCA",
            ...
            >
              ...
              <div id="profileInfosContainer">
                <div className="d-flex justify-content-between align-items-end">
                  <Image alt="profileUserImage" id="profileUserImage" src={people.image} />
